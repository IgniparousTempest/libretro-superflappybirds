...
bool retro_load_game(const struct retro_game_info *info)
{
    ...
    input = {{}, {}, {}, {}, {}, {}, {}, {}};
    game = std::make_unique<Game>(FRAMEBUFFER_WIDTH, FRAMEBUFFER_HEIGHT, core_path, save_dir_path, env_variables.max_players);
    return true;
}
...
void retro_set_environment(retro_environment_t cb)
{
    ...
    if (core_path.empty()) {
        ...
        save_dir_path = std::string(name);
        std::cout << "save dir path: " << save_dir_path << std::endl;
    }
